...
void loop() {
  ...
  while (true) {
    ...
    for(int j = 0; j<6; j++){
      target_v = 0.2;
      if(adc1_buf[j] < 400 || adc2_buf[j] < 400){
        target_theta = (3-j)*3; // I think this makes it variable. 3-6 = -3 so it will turn right as at index 6 it is starting to see the line
      }
    }
    
    // if(adc1_buf[3] <=450 && adc2_buf[2] <= 450 && adc2_buf[3] <= 450){
    //   target_v = 0.1;
    //   target_theta = 0;
    // }
    // if(adc1_buf[2] <350){
    ...
    //   target_v = 0.1;
    // }
    // if(adc1_buf[1] <350 || adc2_buf[1] < 350){
    //   target_theta = -3.5;
    //   target_v = 0.2;
    // }
    // if(adc1_buf[5] <350 || adc2_buf[4] < 350){
    //   target_theta = 3.5;
    //   target_v = 0.2;
    // }
